...
namespace BP_ZalohovaciNastroj
{
    public partial class RecoveryResult : Form
    {
        ...
        private void InitTvw()
        {
            ...
            //if (isFolderNeeded(rootDirectoryInfo)) return;
        ...
        private void lvw_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                FileInfo f = (FileInfo)lvw.SelectedItems[0].Tag;
                lblDateTime.Text = String.Format("Creation: {0}", f.CreationTime.ToString("dd-MM-yyyy HH:mm"));
            }
            else
                lblDateTime.Text = "";
