...
namespace BP_ZalohovaciNastroj
{
    ...
    public partial class Main : Form
    {
        ...
        private TreeNode BuildNodeForFilter(Filter filter, string negateText, string nameOfTheFilter)
        {
            ...
            {
                Text = negateText + nameOfTheFilter + filter.GetType().Name,
                Tag = filter
            };
            return node;
        }
        ...
        private void FillDataToTabControlForAttribute()
        {
            ...
            foreach (var item in attributeFilter.Attributes)
            {
        ...
        private void B_SimulateBackup_Click(object sender, EventArgs e)
        {
            ...
            FilterResult tempForm = new FilterResult(project.FilterManager.Files.ToArray(), FiltersClone, TB_RootPath.Text, TB_DestinationPath.Text);
            tempForm.Show();           
        }
